...
{
    sqlite3_stmt *stmt;
    std::string   insertData("INSERT INTO data "
                               "(pktnum,timestamp,undef,temperature,humidity,ir,vis,batt,avg_temperature,avg_humidity,avg_"
                               "pressure,avg_gas_resistance,eui) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)");
